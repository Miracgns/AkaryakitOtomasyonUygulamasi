...
namespace AkaryakıtOtomasyonUygulaması
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllLines(Application.StartupPath + "\\depo.txt",
                depo_bilgileri);
            txt_depo_oku();
            txt_depo_yaz();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllLines(Application.StartupPath + "\\fiyat.txt",
                fiyat_bilgileri);
            txt_fiyat_oku();
            txt_fiyat_yaz();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (1000 < E_dizel + E_dizel || E_dizel <= 0)
                    textBox3.Text = "Hata!";
                else
            ...
            try
            {
                ...
                if (1000 < E_eurodizel + E_eurodizel || E_eurodizel <= 0)
                    textBox4.Text = "Hata!";
                else
